...
IN_CSV = BASE_DIR / "external_sources" / "ansis_exchangeable_sodium_pct_top10cm.csv"
OUT_CSV = BASE_DIR / "external_sources" / "ansis_exchangeable_sodium_pct_top10cm_alphaearth_5yr.csv"
OUT_META = BASE_DIR / "external_sources" / "ansis_exchangeable_sodium_pct_top10cm_alphaearth_5yr_meta.json"
...
def main():
    ...
    band_names = median.bandNames().getInfo()
