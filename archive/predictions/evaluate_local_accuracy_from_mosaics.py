...
OUT_CSV = BASE_DIR / "outputs" / "predictions" / "local_accuracy_from_mosaics.csv"
OUT_PRED = BASE_DIR / "outputs" / "predictions" / "local_point_predictions_from_mosaics.csv"
