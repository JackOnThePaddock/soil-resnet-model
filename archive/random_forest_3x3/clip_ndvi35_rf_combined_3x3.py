...
BASE_DIR = r"C:\Users\jackc\Documents\EW WH & MG SPEIRS\SOIL Tests\exports\rf_combined_ph_cec_esp_3x3"
...
def main():
    ...
    inputs = [f for f in os.listdir(BASE_DIR) if f.endswith("_rf_bestbands_3x3.tif")]
    if not inputs:
