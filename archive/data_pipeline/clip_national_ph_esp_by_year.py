...
NATIONAL_ESP = BASE_DIR / "external_sources" / "esp_alphaearth_by_year.csv"

OUT_PH = BASE_DIR / "external_sources" / "all_alphaearth_by_year_ph_le85.csv"
OUT_ESP = BASE_DIR / "external_sources" / "esp_alphaearth_by_year_esp_le15.csv"
